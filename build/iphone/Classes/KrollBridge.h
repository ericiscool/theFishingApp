...
@interface TheFishingAppObject : KrollCoverageObject {
#else
@interface TheFishingAppObject : KrollObject {
#endif
@private
...
extern NSString * TheFishingApp$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	TheFishingAppObject *_thefishingapp;
    KrollObject* console;
	BOOL shutdown;
