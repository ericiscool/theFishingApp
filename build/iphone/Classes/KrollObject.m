...
//@interface TheFishingAppObject : NSObject
//@end

@interface TheFishingAppObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[TheFishingAppObject class]])
		{
			for (NSString *key in [[(TheFishingAppObject*)o modules] allKeys])
			{
