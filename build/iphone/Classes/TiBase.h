...
// in simulator we redefine to format for TheFishingApp Developer console
...
{\
	NSString * exceptionName = [@"org.thefishingapp." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.thefishingapp";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UITheFishingAppNativeItemNone = -1, 
	UITheFishingAppNativeItemSpinner = -2,
	UITheFishingAppNativeItemProgressBar = -3,
	
	UITheFishingAppNativeItemSlider = -4,
	UITheFishingAppNativeItemSwitch = -5,
	UITheFishingAppNativeItemMultiButton = -6,
	UITheFishingAppNativeItemSegmented = -7,
	
	UITheFishingAppNativeItemTextView = -8,
	UITheFishingAppNativeItemTextField = -9,
	UITheFishingAppNativeItemSearchBar = -10,
	
	UITheFishingAppNativeItemPicker = -11,
	UITheFishingAppNativeItemDatePicker = -12,
	
	UITheFishingAppNativeItemInfoLight = -13,
	UITheFishingAppNativeItemInfoDark = -14,
	
	UITheFishingAppNativeItemDisclosure = -15,
	
	UITheFishingAppNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all TheFishingApp instances of
