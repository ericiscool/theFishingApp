...
//Rare exceptions to indicate a bug in the _thefishingapp code (Eg, function that a subclass should have implemented)
...
/**
 The base class for TheFishingApp proxies.
 */
