...
/**
 Base class for all TheFishingApp views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the TheFishingApp view hierarchy (such as wrapped iOS UIViews) was touched.
